...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      ...
      bg-dark text-light dark:bg-light dark:text-dark p-7 shadow-dark cursor-pointer"
    ...
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark">
        <motion.div
         ...
         p-7 shadow-dark dark:shadow-light cursor-pointer absolute dark:bg-light dark:text-dark"
          whileHover={{ scale: 1.05 }}
        >
          Web
        </motion.div>
